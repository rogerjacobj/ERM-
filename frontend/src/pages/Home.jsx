    ...
    <div className="home-root">
      ...
      <section className="home-hero">
        <div className="home-hero-content">
          <p className="home-tagline">Bridge the gap between employees and HR</p>
          <h1 className="home-heading">Making A Difference:</h1>
          <h2 className="home-heading-accent">Communication Starts with You</h2>
